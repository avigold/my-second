    ...
    <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row',
      ...
      <div style={{ flexShrink: 0 }}>
        <div style={{ width: boardSize, height: boardSize, position: 'relative' }}>
          <Chessground key={resetKey} width={boardSize} height={boardSize} config={config} />
...
function FeedbackPanel({ feedback, habit, showAnswer }) {
  ...
  const messages = {
    ...
    habit: {
      color: '#f87171', bg: '#450a0a', border: '#7f1d1d',
      ...
      <div style={{ background: '#111827', borderRadius: 8, padding: '12px 16px', marginBottom: 14 }}>
        ...
        {(showAnswer || feedback === 'correct') && (
          <div style={{ display: 'flex', gap: 10, marginBottom: 12 }}>
            <div style={{ flex: 1, background: '#1f2937', borderRadius: 6,
                          padding: '8px 12px', border: '1px solid #450a0a' }}>
            ...
            <div style={{ flex: 1, background: '#1f2937', borderRadius: 6,
                          padding: '8px 12px', border: '1px solid #052e16' }}>
